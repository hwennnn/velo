 ...
 * Balances Page
 *
 * Replaces the settlements modal/page.
 * Two tabs:
 * - Summary: original balances UI
 * - Who owes who: debts list + Settle Up + manual settlement
 */
        ...
        <div className="max-w-3xl mx-auto px-5 pb-3">
          <div className="flex gap-2">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${tab === 'summary' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:bg-gray-100'
                }`}
            >
              Summary
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${tab === 'debts' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:bg-gray-100'
                }`}
            >
              Who owes who
            </button>
