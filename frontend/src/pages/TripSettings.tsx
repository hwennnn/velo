                                ...
                                <div className="space-y-2 min-w-0">
                                    ...
                                    <div className="relative overflow-hidden">
                                        <input
                                            ...
                                            disabled={!isAdmin}
                                            className="w-full min-w-0 max-w-full box-border px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-500 text-sm"
                                        />
                                    </div>
                                </div>
